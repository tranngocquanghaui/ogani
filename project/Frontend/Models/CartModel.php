<?php
	class CartModel{		
		...
		public function cartCheckOut(){			
			...
			$query = $conn->prepare("insert into orders set customer_id=:customer_id, date=now()");
			...
			foreach($_SESSION["cart"] as $product){
				$query = $conn->prepare("insert into orderdetails set order_id=:order_id, product_id=:product_id, price=:price, quantity=:number");
