                ...
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__option">
                            <a href="index.php?controller=shop&action=read">Sản phẩm</a>
                            <span>Shop</span>
                        </div>
                    </div>
                </div>
 ...
 <div class="col-lg-9 col-md-7">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-5">
                <div class="filter__sort">
                    <select onchange="location.href='index.php?controller=shop&action=read&groupPrice='+this.value;">
                    	<option value="0">Sắp xếp theo khoảng giá</option>
                        <option value="1tr-5tr"> 1 triệu đến 5 triệu</option>
                        <option value="5tr-10tr">5 triệu đến 10 triệu</option>
                        <option value="10tr-15tr">10 triệu đến 15 triệu</option>
                        <option value="15tr-20tr">15 triệu đến 20 triệu</option>
                        <option value="20tr">Từ 20 triệu trở lên</option>
                    </select>
                </div>
            </div>
            <div class="col-lg-4 col-md-4">
                <div class="filter__found">
                    <h6><span><?php echo $this->totalRecord(); ?></span>Sản Phẩm</h6>
                </div>
            </div>
    ...
    <div class="product__pagination">
        ...
        <a href="index.php?controller=shop&action=read&p=<?php echo $i; ?>"><?php echo $i; ?></a>
       
        
    <?php endfor; ?>
    <a href="index.php?controller=shop&action=read&p=<?php echo $i; ?>"><i class="fa fa-long-arrow-right"></i></a>
    </div>
</div>
