 ...
 <div class="col-lg-9 col-md-7">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-5">
                <div class="filter__sort">
                    <select onchange="location.href='index.php?controller=products&action=category&id=<?php echo $category_id ?>&groupPrice='+this.value;">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="filter__found">
                    <h6><span><?php echo $this->totalRecord($category_id); ?></span> Products found</h6>
                </div>
            </div>
    ...
    <?php endfor; ?>
    <a href="index.php?controller=products&action=category&id=<?php echo $category_id; ?>&p=<?php echo $i; ?>"><i class="fa fa-long-arrow-right"></i></a>
    </div>
</div>
